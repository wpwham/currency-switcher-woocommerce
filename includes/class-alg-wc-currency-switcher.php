...
class Alg_WC_Currency_Switcher_Main {
	...
	function enqueue_wselect_scripts() {
		...
		$wselect_deps = array(
			'css_url'    => $plugin_url . '/includes/lib/wSelect/wSelect.css',
			'lib_js_url' => $plugin_url . '/includes/lib/wSelect/wSelect.min.js',
			'version'    => $plugin_version,
		);
		wp_localize_script( 'alg-wselect', 'alg_wselect_deps', $wselect_deps );
	}
